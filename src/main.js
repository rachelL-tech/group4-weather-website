// 引入渲染工具
import { renderHourlyForecast, renderDailySummary,renderForecast,renderCurrentWeather, renderLocationPopup, renderFakeData ,renderFakeForecast} from './render.js';
